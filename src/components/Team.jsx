        ...
        <div id="team" className="text-center">
            <div className="container">
                <div className="col-md-8 col-md-offset-2 section-title team-descr">
                    <p>
                        В стенах нашей компании готовое изделие проходит поэтапный контроль качества. Проверяется
                        исправность изоляции каждого компонента, корректность сборки комплектующих и работоспособность
                        изделия в целом.
